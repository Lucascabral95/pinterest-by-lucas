...
//     return (
//         // <div className="about">
//         //     {/* <AboutCabecera prop={"Todo acerca de Pinterest"} /> */}
//         //     <div className="cuerpo-about">

//         //         {/* <div id="contenedor-articulos-mobile">
//         //             <div className="contenedor-titulo">
//         //                 <h2 className="titulo"> Introduccion a Pinterest </h2>
        ...
        <div>
            <div>
                ...
                <div className="articulos-secciones">
                    ...
                    <div className="contenedor-relleno" style={{ display: activeModal.pin ? "block" : "none" }}>
                        <Link to={"/"} className="relleno">Reacciones</Link>
                        <Link to={"/"} className="relleno">Agregar o administrar comentarios en un Pin</Link>
                        <Link to={"/"} className="relleno">Interactua con los Pines</Link>
                    </div>
                    <hr color="#004BA9" />
                    <div className="contenedor-articulos">
                        <p className="subtitulo" style={{ fontWeight: activadorDeModal.perfil ? 700 : 500 }}> Configura tu perfil </p>
                    ...
                    <div className="contenedor-relleno" style={{ display: activeModal.perfil ? "block" : "none" }}>
                        <Link to={"/"} className="relleno" style={{ textDecoration: "underline" }} >Encuentra tu perfil</Link>
                        <Link to={"/"} className="relleno">Modifica tu perfil</Link>
                        <Link to={"/"} className="relleno">Haz que tu perfil sea privado o publico</Link>
                    </div>
                    <hr color="#004BA9" />
                    <div className="contenedor-articulos">
                        <p className="subtitulo" style={{ fontWeight: activadorDeModal.dispositivo ? 700 : 500 }}> Pinterest y tu dispositivo </p>
                    ...
                    <div className="contenedor-relleno" style={{ display: activeModal.dispositivo ? "block" : "none" }}>
                        <Link to={"/"} className="relleno">Actualizar la aplicacion de Pinterest</Link>
                        <Link to={"/"} className="relleno">Agrega un widget de Pinterest</Link>
                        <Link to={"/"} className="relleno">Activar un lector de pantalla para Pinterest</Link>
                        <Link to={"/"} className="relleno">Pinterest Lite</Link>
                        <Link to={"/"} className="relleno">Modo noche</Link>
                        <Link to={"/"} className="relleno">Concede las autorizaciones en Android</Link>
                        <Link to={"/"} className="relleno">Concede las autorizaciones en IOS</Link>
                        <Link to={"/"} className="relleno">Dirigido a App Store, Play Store o Amazon</Link>
                    </div>
                    <hr color="#004BA9" />
                    <div className="contenedor-articulos">
                        <p className="subtitulo" style={{ fontWeight: activadorDeModal.herramientas ? 700 : 500 }}> Funciones y herramientas </p>
                    ...
                    <div className="contenedor-relleno" style={{ display: activeModal.herramientas ? "block" : "none" }}>
                        <Link to={"/"} className="relleno">Administra la configuracion de reproduccion automatica</Link>
                        <Link to={"/"} className="relleno">Comprar mediante Pines de productos</Link>
                        <Link to={"/"} className="relleno">Administrar tu lista de compras</Link>
                        <Link to={"/"} className="relleno">Usar la funcion de Prueba</Link>
                        <Link to={"/"} className="relleno">Tableros secretos</Link>
                        <Link to={"/"} className="relleno">Tu informe Pinterest Predicts </Link>
                    </div>
                    <hr color="#004BA9" />
                </div>
            </div>
