                ...
                cuerpo={
                    <div>
                        ...
                        <div className="disponibilidad-ios">
                            <p className="cuerpo-texto">Actualmente Shuffles solo está disponible para iOS. Para acceder a Shuffles, debes tener un dispositivo iOS con la versión más reciente del sistema operativo.</p>
                        </div>
                        <p className="cuerpo-texto">Shuffles es una herramienta de collage que te permite crear, publicar y compartir contenido visual. Puedes <a href="#" style={{ fontWeight: 600 }}>descargar Shuffles desde la tienda de Apple</a>.</p>
                        <h2 className="titulo-pinterest">Inicia sesión en Shuffles</h2>
                        <p className="cuerpo-texto">Inicia sesión en Shuffles con tu cuenta de Pinterest. Si no tienes una cuenta, se te pedirá que crees una a través de la aplicación de Shuffles. Shuffles también funciona con cuentas para empresa.</p>
                        <h2 className="titulo-pinterest">Crea tu primer Shuffle</h2>
                        ...
                        <p className="cuerpo-texto">It looks like you're reading this from a web browser. At the moment, Shuffles is only available on iOS and Android mobile devices.</p>
                        ...
                        <ul style={{ marginLeft:"4%" }}>
                            ...
                            <li>Para Shuffles privados, selecciona <a href="#" style={{ fontWeight: 600 }}>Hacer Shuffle publico</a> y luego <a href="#" style={{ fontWeight: 600 }}>Hacer Publico</a>.</li>
                        </ul>
                        <p className="cuerpo-texto">También puedes hacer públicos o privados tus Shuffles en tu configuración. Haz clic en  el icono de los puntos suspensivos en la esquina superior derecha de la pantalla. A continuación, selecciona <a href="#" style={{ textDecoration: "underline", fontWeight: 600 }}>Cuenta</a>. Desde ahí, activa o desactiva la opción <a href="#" style={{ textDecoration: "underline", fontWeight: 600 }}>Publicacion Automatica</a>.</p>
                        <div className="d-flex web-android-ios">
                            <a href="#" style={{ textDecoration: "underline" }}>WEB</a>
                            <a href="#" style={{ textDecoration: "underline" }}>ANDROID</a>
                            <a href="#" style={{ textDecoration: "underline" }}>IOS</a>
                        ...
                        <p className="cuerpo-texto">It looks like you're reading this from a web browser. At the moment, Shuffles is only available on iOS and Android mobile devices.</p>
                        <h2 className="titulo-pinterest">Marcar como favorito un Shuffle o ver el Pin original</h2>
                        <p className="cuerpo-texto">1) Inicia sesión en tu cuenta de Shuffles en tu dispositivo iOS. </p>
                        <p className="cuerpo-texto">2) Toca tu Shuffle. </p>
                        ...
                        <p className="cuerpo-texto">It looks like you're reading this from a web browser. At the moment, Shuffles is only available on iOS and Android mobile devices.</p>
                        <h2 className="titulo-pinterest">Elimina tus datos y tu cuenta</h2>
